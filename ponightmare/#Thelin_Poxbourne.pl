...
sub EVENT_SAY{
	...
	quest::emote("screams loudly, and then falls asleep once again.");
      ...
      if($text=~/Hail/i && ($entry == 1 || $entry == 2 || $entry == 3 || $entry == 4 || $entry == 5 || $entry == 6 || $entry == 7 || $entry == 8 || $entry == 9 || $entry == 10 || $entry == 11|| $entry == 12 || $entry == 13 || $entry == 14 || $entry == 15 || $entry == 16 || $entry == 17) && $pop_pon_hedge_jezith == 1){
      ...
      if($text=~/ready/i && ($entry == 1 || $entry == 2 || $entry == 3 || $entry == 4 || $entry == 5 || $entry == 6 || $entry == 7 || $entry == 8 || $entry == 9 || $entry == 10 || $entry == 11|| $entry == 12 || $entry == 13 || $entry == 14 || $entry == 15 || $entry == 16 || $entry == 17) && $pop_pon_hedge_jezith == 1){
      	...
      	$entry=$entry+1;
         quest::debug("Entry number $entry of the Hedge trial entered.");
      	}   
